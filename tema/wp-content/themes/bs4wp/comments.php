<?php if( is_single() || is_page()) : ?>
    <div class="blog-comments">
        <?php if(have_comments() && comments_open() ) : ?>
            <h5 class='comments' class='mb-3'>
                <?php comments_number(__('comentários'), __('1 comentério'), '%' . __(' comentários')); ?>
            </h5>
